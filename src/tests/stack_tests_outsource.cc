...
TEST(stack, case1) {
  ...
  EXPECT_THROW(s21_stack_int.top(), std::out_of_range);
  EXPECT_THROW(s21_stack_int.pop(), std::out_of_range);

  EXPECT_EQ(s21_stack_double.size(), 0U);
  EXPECT_THROW(s21_stack_double.top(), std::out_of_range);
  EXPECT_THROW(s21_stack_double.pop(), std::out_of_range);

  EXPECT_EQ(s21_stack_string.size(), 0U);
  EXPECT_THROW(s21_stack_string.top(), std::out_of_range);
  EXPECT_THROW(s21_stack_string.pop(), std::out_of_range);
}
...
TEST(stack, case3) {
  ...
  EXPECT_EQ(s21_stack_ref_int.size(), 5U);
  EXPECT_EQ(s21_stack_ref_int.top(), 1);
